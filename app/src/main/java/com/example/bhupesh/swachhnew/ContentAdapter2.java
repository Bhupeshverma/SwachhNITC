...
public class ContentAdapter2 extends  RecyclerView.Adapter <ContentAdapter2.OrgViewHolder> {
    Context c;
    ArrayList<Posts> players;

    String email;

    public ContentAdapter2(Context c, ArrayList<Posts> depts) {
        this.c = c;
        this.players=depts;
    ...
    public void onBindViewHolder(OrgViewHolder orgViewHolder, final int i)
    {
        ...
        final String name = players.get(i).getDepartment_name();
...

        {
            ...
            orgViewHolder.Name.setText(players.get(i).getDepartment_name());
