...
public class ParserFetch extends AsyncTask<Void,Integer,Integer> {
    ...
    ContentAdapter2 adapter;

    public ParserFetch(Context c, String data, RecyclerView rv) {
        this.c = c;
        this.data = data;
        this.rv = rv;
    ...
    protected void onPostExecute(Integer integer) {
        ...
        if (integer==1)
        {
            adapter=new ContentAdapter2(c,depts);
