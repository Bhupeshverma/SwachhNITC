...
public class DownloaderOpen extends AsyncTask<String,Integer,String>
{
    ...
    public DownloaderOpen(Context c, String urlAddress, RecyclerView rv) {
        this.c = c;
    ...
    protected void onPostExecute(String data) {
        ...
        if (data!=null)
        {
            ParserOpen p=new ParserOpen(c,data,rv);
            p.execute();
