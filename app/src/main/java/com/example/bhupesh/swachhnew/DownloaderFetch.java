...
public class DownloaderFetch extends AsyncTask<String,Integer,String>
{
    ...
    public DownloaderFetch(Context c, String urlAddress, RecyclerView rv) {
        this.c = c;
    ...
    protected void onPostExecute(String data) {
        ...
        if (data!=null)
        {
            ParserFetch p=new ParserFetch(c,data,rv);
            p.execute();
